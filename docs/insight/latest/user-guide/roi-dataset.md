---
id: roi-dataset
title: Business Dataset (ROI)
sidebar_label: Business Dataset
sidebar_position: 3
description: Configure manual time and hourly cost values used in Business ROI dashboards.
...
If a user has permission to control DATASET\_RESOURCE, they can configure the baselines for workflows. If the admin has not entered any values in the dataset, the Business Dashboard will not be viewable until values are provided.
...
3. Search **jhi\_dataset**table and drag it to the data source interface.
