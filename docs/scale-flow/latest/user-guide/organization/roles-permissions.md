...
4. Admin creates a separate `AI Manager` role for the person who manages [AI Assistant](../scaleflow-ai/ai-assistant), [AI Agent](../scaleflow-ai/ai-agent-usage), and [Knowledge](../scaleflow-ai/knowledge-usage).
