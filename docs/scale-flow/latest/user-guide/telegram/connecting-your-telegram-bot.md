...
After connection, customer chats with your bot appear in [Inbox](../inbox-usage).
...
2. In ScaleFlow, open [Inbox](../inbox-usage), pick the conversation, and confirm the text appears.
...
- [Inbox Usage](../inbox-usage) — handle conversations
