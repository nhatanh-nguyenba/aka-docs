...
id: close-browser
title: "ブラウザを閉じる"
sidebar_label: "ブラウザを閉じる"
sidebar_position: 2
description: "ブラウザアクティビティのドキュメントを閉じます。"
...
「ブラウザを閉じる」は、現在のブラウザを閉じます。これにより、「ブラウザを開く」アクティビティによって開かれたウィンドウ ブラウザのみが閉じられます。
